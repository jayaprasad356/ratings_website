...
define('DOMAIN_URL', 'https://ratingsweb.graymatterworks.com/');
define('API_URL', 'https://lifetimeads.graymatterworks.com/api/');
...
class Database
{
    ...
    private $db_user = "u743445510_lifetimeads";
    private $db_pass = "Lifetimeads@2024"; 
    private $db_name = "u743445510_lifetimeads"; 
